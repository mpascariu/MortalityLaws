...
The package can be installed from two different sources, `CRAN` and `GitHub`. Most people would choose the first option (see below).
...
In this case you will need to have `devtools` R package already installed, otherwise uncomment the fist line and install it.
